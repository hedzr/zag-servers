...
import com.obsez.zag.demostreamrmqpublisher.rmq.fanout.FanoutSender;
import com.obsez.zag.demostreamrmqpublisher.rmq.many.NeoSender1;
import com.obsez.zag.demostreamrmqpublisher.rmq.many.NeoSender2;
...
public class MqService {
    ...
    public void sendBroadcast(String msg) {
        ...
        //logger.info("sending 2: {}", text);
        for (int i = 0; i < 5; i++) {
            fanoutSender.send(String.format("%s [%d]", msg, i));
        }
    }
