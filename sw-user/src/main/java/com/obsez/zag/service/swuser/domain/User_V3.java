...
public class User_V3 {
    ...
    private int burrencyBeans;//豆币

    private int burrencyBeansDiscount;//豆币汇率
    ...
    public User_V3(int userId, String unionid, int accType, String regTime, String noticephone, String channelId, String pushId, String password, String userLevelname, String userLevel, String username, double balance, double mealDiscount, String headImg, String nickName, String sex, String isnew, int burrencyBeans, int burrencyBeansDiscount, String city, String phone, String appid) {
        this.userId = userId;
