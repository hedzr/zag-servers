...
public class User_V2 {
    ...
    public User_V2(int userId, String unionid, int accType, String regTime, String noticephone, String channelId, String pushId, String password, String userLevelname, String userLevel, String username, double balance, double mealDiscount, String headImg, String nickName, String sex, String isnew, int burrencyBeans, int burrencyBeansDiscount, String city, String phone) {
        this.userId = userId;
